...
// Users is the part of the account store a session needs: whether the account
// behind a cookie is still live, and what it may still do. Taking the interface
// keeps the cache from depending on the database.
type Users interface {
	Exists(ctx context.Context, userID string) (bool, error)
	LiveRole(ctx context.Context, userID, organizationID string) (organization.Role, error)
}
